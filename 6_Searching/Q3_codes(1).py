...
def read_file(filename):
    ...
    # Ensure correctness but not used directly
...
if dual_sorted_search(data_500k, len(data_500k), search_key_500k, dual_index_2):
    ...
    print(
        f"Elements: {data_500k[dual_index_2[0]]} + {data_500k[dual_index_2[1]]} = {search_key_500k}")
else:
    print("No pair found.")
...
if dual_sorted_search(data_1m, len(data_1m), search_key_1m, dual_index_1):
    ...
    print(
        f"Elements: {data_1m[dual_index_1[0]]} + {data_1m[dual_index_1[1]]} = {search_key_1m}")
else:
    print("No pair found.")
